...
layout: post
title: 'Data'
subtitle: 'What data did we use & how we pre-processed it?'
background: '/img/data_bw.jpg'
author: Jonathan Hecht
---
To answer the research question, two different approaches for data preparation and later training of the model were performed (cf. [Methods](https://jp-hecht.github.io/GANmapper-Project/2023/03/03/methods.html)). Both approaches aim to include the known requirements and known information from the original GANmapper article[^1]. The second attempt could not be tested afterwards, but it is a further development of the first approach and accordingly takes over large parts of the first approach. The background of why the second approach could not be tested in practice is explained in the [Discussion section](https://jp-hecht.github.io/GANmapper-Project/2023/03/03/2023-07-07-discussion.md).
